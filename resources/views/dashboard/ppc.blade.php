...
<div class="row">
    <div class="col-12 col-md-3">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="d-inline-block">
                        <h5 class="text-muted">CCR yang belum diproses</h5>
                        <h2 class="mb-0">Total : {{$total_ccr_belum}}</h2>
                    </div>
                    <div class="float-right icon-circle-medium  icon-box-lg  bg-brand-light mt-1">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <div class="d-inline-block">
                        <h5 class="text-muted">Perkerjaan Selesai</h5>
    ...
    <div class="col-12 col-md-9">
        <div class="card w-100">
            <h5 class="card-header">Grafik Pekerjaan Selesai tahun ini</h5>
            <div class="card-body">
                <livewire:grafik.ppc />
            </div>
        </div>
