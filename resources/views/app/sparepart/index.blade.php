...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
            <h2 class="pageheader-title">Data SparePart</h2>
        </div>
    </div>
</div>
        ...
        <div class="card">
            <div class="card-header d-flex" >
                ...
                <div class="toolbar ml-auto">
                    <a href="{{route($rAdd)}}" class="btn btn-primary float-right">Buat Surat Jalan</a>
                </div>
            </div>
            <div class="card-body">
...
@section('script')
    ...
    <script>
        $(function () {
            ...
            function title(){
                title = 'Export Data Sparepart ' + $('input[name=from]').val() +' - '+ $('input[name=to]').val()
                return title
            }
