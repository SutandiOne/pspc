...
class Marketing extends Component
{
    ...
    public function render()
    {
        ...
        $spareparts = SparePart::where('marketing_id', Auth::user()->marketing->id)->whereYear('date_received', $year)->get();

        $sparepart = $spareparts->countBy(function($d) {
            return Carbon::parse($d->date_received)->format('m');
        });
        ...
        return view('livewire.grafik.marketing')->with([
